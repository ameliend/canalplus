(() => {
  ...
  if (searchIcon && searchIcon.tagName.toLowerCase() !== 'button') {
    ...
    searchButton.style.cssText = 'width:24px;height:24px;padding:0;border:0;background:transparent;color:inherit;cursor:pointer';
    searchButton.innerHTML = '<img src="./search-icon.svg" alt="" width="24" height="24">';
